local MAP_TO_CHECK = {
    ...
    ["@Hyrule Overworld/Eastern Ruins/Hookshot Chest/Chest"] = "eastern_ruins_hookshot_chest_got_item",
    ["@Hyrule Overworld/Eastern Ruins/Merge Chest/Chest"] = "eastern_ruins_merge_chest_got_item",
